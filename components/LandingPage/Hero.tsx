        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mt-2 sm:mt-0">
          <div>
            ...
            <p className="mt-5 text-base md:text-lg text-slate-600">
              Synced is a shared home for your relationship—places to eat, a
              living photo gallery, notes, tasks, countdowns and more. All in
              one private space built for two.
            </p>
          ...
          <div className="relative">
            ...
            <div className="relative rounded-2xl ring-1 ring-slate-200 bg-white p-4 md:p-6">
              ...
              <div className="grid grid-cols-2 gap-3 mt-4">
                ...
                <div className="rounded-xl border border-slate-200 bg-white p-4 hover:border-slate-300 transition-colors">
                  ...
                  <p className="mt-3 text-xs text-slate-600 line-clamp-3">
                    Trip ideas: Lake weekend, moonlight cinema, ramen crawl.
                    Remember to book tickets for Saturday’s show.
                  </p>
                </div>
                {/* Gallery */}
                <div className="rounded-xl border border-slate-200 bg-white p-4 hover:border-slate-300 transition-colors col-span-2">
                  <div className="flex items-center gap-2">
                    <div className="h-8 w-8 rounded-lg bg-emerald-600/15 text-emerald-600 ring-1 ring-inset ring-emerald-500/20 flex items-center justify-center">
                      <ImageIcon data-lucide="image" className="w-4 h-4" />
                    </div>
                    <span className="text-sm font-semibold tracking-tight text-slate-900">
                      Photo gallery
                    </span>
                  ...
                  <div className="mt-3 grid grid-cols-4 gap-2">
                    <Image
                      className="w-full h-20 rounded-lg object-cover ring-1 ring-slate-200"
                    ...
                    <Image
                      className="w-full h-20 rounded-lg object-cover ring-1 ring-slate-200"
                      src="https://images.unsplash.com/photo-1494883759339-0b042055a4ee?q=80&w=400&auto=format&fit=crop"
                      alt="gallery 3"
                      width={80}
                      height={64}
                      unoptimized={true}
                    ...
                    <Image
                      className="w-full h-20 rounded-lg object-cover ring-1 ring-slate-200"
                      src="https://images.unsplash.com/photo-1520975916090-3105956dac38?q=80&w=400&auto=format&fit=crop"
                      alt="gallery 4"
                      width={80}
                      height={64}
                      unoptimized={true}
              ...
              <div className="mt-4 rounded-lg bg-slate-50 ring-1 ring-inset ring-slate-200 p-3 text-xs text-slate-500">
                Tip: Invite your partner with a generated code. Everything stays
